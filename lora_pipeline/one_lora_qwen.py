...
def _inject_qwen_workflow_payload(
    wf: Dict[str, Any],
    *,
    seed: int,
    base_model_name: str,
    ...
    wf["37"]["inputs"]["unet_name"] = str(base_model_name)
    wf["60"]["inputs"]["filename_prefix"] = str(filename_prefix)
    wf["79"]["inputs"]["lora_name"] = str(lora_name)
            ...
            for img_idx, img_url in enumerate(images):
                ...
                if save_prompt_json:
                    meta = {
                        ...
                        "seed": int(new_seed),
                        "workflow": wf_json,
                        "mode": "custom_workflow_qwen_one_lora",
                        "sel_idx": int(sel_idx),
                        "endpoint": url,
                    }
